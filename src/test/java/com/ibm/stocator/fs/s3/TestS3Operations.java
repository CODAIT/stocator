...
import com.ibm.stocator.fs.swift2d.SwiftTestUtils;

/**
 * Created by hntd on 2/29/2016.
 */
public class TestS3Operations extends S3BaseTest {

  protected byte[] data = SwiftTestUtils.generateDataset(1024 * 2, 0, 255);
