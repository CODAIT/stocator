...
/**
 * A specific exception from AWS operations. The exception must always be
 * created with an {@link AmazonServiceException}. The attributes of this
 * exception can all be directly accessed.
 */
@InterfaceAudience.Public
@InterfaceStability.Evolving
public class COSServiceIOException extends COSClientIOException {
   ...
   */
  public COSServiceIOException(String operation, AmazonServiceException cause) {
